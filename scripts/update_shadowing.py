...
EXISTING_KEYWORDS = "뷰티, 방산, 조선, 원전, 반도체, 건설, 우주항공, 게임, 로봇, AI, 바이오, 전력설비, 통신, 드론, 자동차, 2차전지"
...
그리고 각 종목의 'keyword' 속성에는 반드시 아래의 '핵심 테마' 목록 중 가장 적합한 1개만 골라서 넣어주세요.
(예: '반도체 장비', '반도체 부품', 'HBM' 등은 모두 '반도체'로 분류. '스페이스 X' 관련주는 '우주항공'으로 분류)
핵심 테마 목록: {EXISTING_KEYWORDS}
절대로 위 핵심 테마 목록에 없는 단어를 사용하거나, '개별이슈', '기타', '미분류' 등의 단어를 사용하지 마세요.
