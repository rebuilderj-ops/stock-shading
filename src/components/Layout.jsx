...
import { LayoutDashboard, BookOpen, CalendarDays, Settings, Activity, Menu, X, Sun, Moon, Minus, Plus, Globe, Newspaper } from 'lucide-react';
...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/news-briefing', name: '주요 뉴스 영향력', icon: <Newspaper size={18} /> },
